...
func _ready() -> void:
	...
	var canvas_rid = get_canvas()
	
	VisualServer.viewport_attach_canvas(viewport_rid, canvas_rid)
	VisualServer.canvas_item_add_line(canvas_rid, POS, SIZE, Color.red, 4.0, false)
